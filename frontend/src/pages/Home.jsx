...
const STRIPS = 8
const STAGGER_MS = 90 // per-column delay
const PART_APPEAR_MS = 420 // how long a single strip takes to slide into/out of place
const ASSEMBLE_MS = (STRIPS - 1) * STAGGER_MS + PART_APPEAR_MS
const HOLD_MS = 2200 // hold the complete, fully-sharp image
const TEXT_EXIT_MS = 420 // how long the text block takes to drop away before the wipe starts
...
const Strips = ({ image, revealed, settled, mode }) => (
  <div
    className={`absolute inset-0 transition-transform ease-linear duration-[2600ms] ${mode === 'enter' && settled ? 'scale-[1.06]' : 'scale-100'
      }`}
  >
